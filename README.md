...
### Printing bins in vase mode

If you would like to print your bins in vase mode, simply check the "Export as 'Vase Mode' object" option under page settings. This will prepare the .obj files differently so you can print them in vase mode.
